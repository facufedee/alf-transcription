...
const schema = z.object({
  ...
  // Manual activity control was only needed for conversational models (gemini-3.8-live).
  // Dedicated transcribe models (gemini-3.5-transcribe-live) use native VAD automatically.
